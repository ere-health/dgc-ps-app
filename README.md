...
| `CONNECTOR_BASE_URI` | Base URI for the connector (protocol+host+port, **no** trailing slash); will be used for discovery via `/connector.sds` of the other connector endpoints (see `*_ENDPOINT_ADDRESS`) | `https://192.168.1.1` |
