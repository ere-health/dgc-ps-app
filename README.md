...
| `CONNECTOR_BASE_URI_CHECK` | Check for the connector uris (when using endpoint autodiscovery) to match the `CONNECTOR_BASE_URI`; default value: `false`; recommendation: `true` | `true` |
